...
//   fetchGenieNewChats,
//   genieReadPostById,
// } from "services/getGenieData";
// import { getpostById } from "services/getGenieData";
// export const initialState = {
//   userId: "",
//   userName: "",
//   NickName: localStorage.getItem("genie-nickName") || "genie",
//   userType: "",
//   isNewChat: true,
//   loginStatus: false,
//   mode: "development",
...
//     try {
//       localStorage.setItem("geniePosts", JSON.stringify(posts));
//     } catch (error) {
...
//       NickName: NickName,
//     }));
//     localStorage.setItem("genie-nickName", NickName);
//   },
//   getUsername: () => {
//     const state = get();
//     let userName =
...
//   getNickName: () => {
//     let NickName =
//       get().NickName || localStorage.getItem("genie-nickName") || "user";
//     return NickName;
//   },
//   cleanGeniePosts: () => {
...
//   //     // Fetch from server
//   //     const res = await fetchGeniePosts();
...
//     }
//   },
//   handleGenieNotRead: async () => {
//     try {
//       console.log("start handleUserNotRead");
//       const newPosts = await fetchGenieNewChats();
//       if (newPosts.length === 0) {
//         return { status: "no new chats" };
//       } else {
//         const curentPosts = JSON.parse(localStorage.getItem("geniePosts"));
...
//     }
//   },
//   getGeniePostById: async (post_id) => {
//     try {
//       // console.log("start getPostById");
//       const newPost = await getpostById(post_id); ///////////////////////////////////////
//       // console.log("newPost", newPost);
//       const localStoragePosts = JSON.parse(localStorage.getItem("geniePosts"));
...
//         localStorage.setItem("geniePosts", JSON.stringify(filteredPosts));
//       } else {
//         localStorage.removeItem("geniePosts");
//       }
//       return true;
//     } catch (err) {
//       console.log("error in getGeniePostById", err);
//       return false;
//     }
//   },
